...
## 🔗 Links
- 🤗 **Model on HF Hub**: [your-username/medical-chatdoctor-mistral7b](https://huggingface.co/your-username/medical-chatdoctor-mistral7b)
- 📓 **Colab Notebook**: [Open in Colab](https://colab.research.google.com/github/your-username/medical-llm-finetuning/blob/main/notebook/medical_llm_finetuning.ipynb)
